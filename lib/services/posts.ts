...
export const posts = {
  async list(
    ...
    console.log(`[posts] list temporarily disabled - using backend API instead: ${userId}`)
  ...
  async get(userId: string, id: string): Promise<PostItem> {
    ...
    // Temporary mock response until backend API is implemented
    console.log(`[posts] get temporarily disabled - using backend API instead: ${userId}, ${id}`)
    throw new ApiError(501, 'NOT_IMPLEMENTED', 'This endpoint is temporarily disabled. Please use the backend API instead.')
  },
  ...
  async cancel(userId: string, id: string, reason?: string): Promise<void> {
    ...
    console.log(`[posts] cancel temporarily disabled - using backend API instead: ${userId}, ${id}`)
  },
  ...
  async postToX(userId: string, postId: string): Promise<void> {
    ...
    console.log(`[posts] postToX temporarily disabled - using backend API instead: ${userId}, ${postId}`)
  },
}
